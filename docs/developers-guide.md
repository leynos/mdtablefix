...
| `emit_pending_with_verbatim_continuation` — Emits a pending prefix plus the raw continuation line when width fallback must preserve ambiguous inline-code source.                                                                                              | `src/wrap/paragraph.rs`           |
