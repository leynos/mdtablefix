...
///
/// This is the window the conditional replacement exists to close: the text was
/// read, the formatter ran, and by the time the swap was ready the file was
/// somebody else's. Overwriting it would discard work this run never saw.
#[test]
